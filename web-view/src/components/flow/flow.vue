...
[class^="weui-wepay-flow__info-"]{
  .setBubbleCommon(15px,#9ACD58,10px,#FFF,2px);
  position: absolute;
...
.weui-wepay-flow__info-bottom{
  ...
  .setBubblePrivate(bottom,#9ACD58);
}
